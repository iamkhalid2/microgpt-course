...
flowchart LR
    ...
    style B fill:#6a3de8,stroke:#6a3de8,color:#fff
    style C fill:#5830d1,stroke:#5830d1,color:#fff
    style D fill:#4623ba,stroke:#4623ba,color:#fff
    style E fill:#2e1a8a,stroke:#2e1a8a,color:#fff
